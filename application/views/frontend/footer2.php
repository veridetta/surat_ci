                    ...
                    surat.forEach(item => {
                        $('.file-div').append(
                                ...
                                <div class="col-lg-12 mt-2">
                                    <label for="file">File Berkas/Lampiran ${item} <sup class="text-danger">*PDF Recommended! | Max 5MB</sup></label>
                                    <?= form_upload(['name' => 'files[]', 'id' => 'file', 'class' => 'form-control input-file']) ?>
                                </div>
                                `
                            )
                    });
